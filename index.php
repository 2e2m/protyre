...
<body style="background-image: url('assets/images2/background.jpg');background-position: center;
							...
							<p class="lead">
								Entre com a sua conta para continuar
									...
									<div class="text-center">
										<img src="assets/images2/logotcm.png" alt="Charles Hall" class="img-fluid rounded-circle" width="132" height="132" />
									</div>
									<form action="login.php" method="post">
										...
										<div class="text-center mt-3">
											<!--<a href="index.html" class="btn btn-lg btn-primary">Entrar</a>-->
											 <button type="submit" name="btn" class="btn btn-lg btn-success">Entrar</button> 
										</div>
									</form>
								</div>
							</div>
