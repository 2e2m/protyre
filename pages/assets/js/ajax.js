...
function call_ajax_page(page) {
	...
	if(page === "index.html")
	{
		document.title = "Dashboard |  Skote - Responsive Bootstrap 4 Admin Dashboard";
	}
	else
	{
		var title = page.replace(".html", "");
		var title1 = title.replace("-", " ");
		document.title = title1.charAt(0).toUpperCase() + title1.slice(1) + " | Skote - Responsive Bootstrap 4 Admin Dashboard";
	}
