...
<head>
    ...
    <!-- App favicon -->
    <link rel="shortcut icon" href="assets/images/favicon22.ico">
...
<body data-sidebar="dark">
    ...
    <div id="layout-wrapper">
                        ...
                        <div class="dropdown-menu dropdown-menu-lg dropdown-menu-end p-0"
                            ...
                            <div class="p-3">
                                <div class="row align-items-center">
                                    ...
                                    <div class="col-auto">
                                        <a href="#!" class="small" key="t-view-all"> Ver tudo</a>
                                    </div>
                                </div>
                            </div>
                    ...
                    <div class="dropdown d-inline-block">
                        ...
                        <div class="dropdown-menu dropdown-menu-end">
                            ...
                            <a class="dropdown-item" href="#"><i
                                    ...
                                    key="t-lock-screen">Bloquear o Ecra</span></a>
            ...
            <div data-simplebar class="h-100">
                ...
                <div id="sidebar-menu">
                    ...
                    <ul class="metismenu list-unstyled" id="side-menu">
                       ...
                       <li>
                            <a href="equipamentos.php" class="waves-effect">
                                <i class="bx bx-calendar"></i>
                                <span key="t-calendar">Equipamentos</span>
                            </a>
                        </li>
                        ...
                        <li>
                            <a href="javascript: void(0);" class="has-arrow waves-effect">
                                ...
                                <span key="t-ecommerce">Operação</span>
                            </a>
                            <ul class="sub-menu" aria-expanded="false">
                                <li><a href="abrir_obra.php" key="t-products">Abrir obra</a></li>
                                <li><a href="ecommerce-product-detail.html" key="t-product-detail">Obras finalizadas</a>
                                </li>
                        ...
                        <li>
                            <a href="javascript: void(0);" class="has-arrow waves-effect">
                                ...
                                <span key="t-crypto">Stock</span>
                            </a>
                            <ul class="sub-menu" aria-expanded="false">
                                <li><a href="crypto-wallet.html" key="t-wallet">Cadastrar pneus</a></li>
                                <li><a href="crypto-buy-sell.html" key="t-buy">Pedidos de aquisição</a></li>
                                 <li><a href="crypto-exchange.html" key="t-exchange">Pedidod MAN</a></li>
                        ...
                        <li>
                            <a href="javascript: void(0);" class="has-arrow waves-effect">
                                ...
                                <span key="t-email">Manutenção</span>
                            </a>
                            <ul class="sub-menu" aria-expanded="false">
                                <li><a href="aprovarobra.php" key="t-inbox">Aprovar obra</a></li>
                                <li><a href="email-read.html" key="t-read-email">Fechar obra</a></li>
                                <li><a href="email-read.html" key="t-read-email">Obras finalizadas</a></li>
                                 <!-- <li>
        ...
        <footer class="footer">
            <div class="container-fluid">
                <div class="row">
                    <div class="col-sm-6">
                        <script>document.write(new Date().getFullYear())</script> © Protire
                    </div>
                    <div class="col-sm-6">
                        <div class="text-sm-end d-none d-sm-block">
                            Desenhado & Desenvolvido pela InovatisMz
                        </div>
                    </div>
                </div>
            </div>
    ...
    <div class="right-bar">
        <div data-simplebar class="h-100">
            ...
            <!-- Settings -->
            <hr class="mt-0" />
            <h6 class="text-center mb-0">Escolha o seu Tema</h6>
